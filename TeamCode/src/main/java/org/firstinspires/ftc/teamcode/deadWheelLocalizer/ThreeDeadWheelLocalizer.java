package org.firstinspires.ftc.teamcode.deadWheelLocalizer;
...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2127.9792624586157; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2064.636439979827; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2321.8622318915013; // x position of the perpendicular encoder (in tick units)
    }
